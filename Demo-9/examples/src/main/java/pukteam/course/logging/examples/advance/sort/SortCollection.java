...
import com.att.biq.day27.logging.examples.advance.sort.jdk.collection.NativeCollectionBasedSorter;
...
public interface SortCollection {
    ...
    static com.att.biq.day27.logging.examples.advance.sort.SortCollection get(SORT_ALG sortAlg) {
        switch (sortAlg) {
            case BUBBLE:
